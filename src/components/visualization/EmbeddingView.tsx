          ...
          {depthMode === 'simple' ? (
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-center gap-6 py-4">
                {/* Token列表 */}
                <div className="text-center">
                  <p className="text-gray-400 text-sm mb-3">Token（词语）</p>
                ...
                >
                  <span className="text-3xl text-cyber-accent-cyan">→</span>
                  <span className="text-xs text-gray-500 mt-1">嵌入</span>
                </motion.div>

                {/* 向量列表 */}
                <div className="text-center">
                  <p className="text-gray-400 text-sm mb-3">Vector（数字）</p>
                  <div className="flex flex-wrap justify-center gap-2 max-w-[280px]">
                    {vectors.slice(0, 5).map((v, i) => (
                      <motion.div
                        ...
                        className="px-3 py-2 bg-cyber-bg-secondary rounded-lg text-xs text-cyber-accent-cyan font-mono"
                      >
              ...
              <div className="relative h-72 bg-cyber-bg-secondary rounded-xl border border-gray-700 overflow-hidden">
                ...
                {/* 说明文字 */}
                <div className="absolute bottom-2 left-1/2 transform -translate-x-1/2 bg-cyber-bg-card/80 px-3 py-1 rounded text-xs text-gray-400">
                  💡 意思相近的词，在图中距离更近
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-center gap-6 mb-4">
                <div className="flex items-center gap-2">
                  <span className="text-sm text-gray-400">向量维度：</span>
                  <span className="text-cyber-accent-cyan font-medium text-lg">{example.embeddings.dimensions}</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-sm text-gray-400">Token数量：</span>
                  <span className="text-cyber-accent-purple font-medium">{vectors.length}</span>
                </div>
              </div>
              ...
              <div className="space-y-3">
                {vectors.map((v, i) => (
                  <motion.div
                    ...
                    animate={{ opacity: 1, x: 0 }}
                    transition={{ delay: i * 0.1 }}
                    className="flex items-center gap-4 p-3 bg-cyber-bg-secondary rounded-lg hover:bg-cyber-bg-secondary/80 transition-colors"
                    onMouseEnter={() => setHoveredVector(i)}
                    onMouseLeave={() => setHoveredVector(null)}
                  >
                    {/* Token名称 */}
                    ...
                    {/* 向量条形图 */}
                    <div className="flex-1 h-10 bg-cyber-bg-card rounded-lg overflow-hidden flex items-center px-2">
                      <AnimatePresence>
                        {hoveredVector === i && (
                          <motion.div
                            initial={{ opacity: 0 }}
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Tooltip termId="vector">
                        <span className="text-cyber-accent-cyan text-xs cursor-help">ℹ️</span>
                      </Tooltip>
                    </div>
                  </motion.div>
                ))}
              ...
              {/* 维度解释 */}
              <div className="bg-cyber-bg-secondary rounded-lg p-4 mt-4">
        ...
        {depthMode === 'simple' ? (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-cyber-bg-secondary rounded-lg p-4">
                <h4 className="text-cyber-accent-cyan font-medium mb-2">🎯 核心思想</h4>
                <p className="text-gray-400 text-sm">
              ...
              <div className="bg-cyber-bg-secondary rounded-lg p-4">
                <h4 className="text-cyber-accent-purple font-medium mb-2">💡 实际应用</h4>
                <p className="text-gray-400 text-sm">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              <div className="bg-cyber-bg-secondary rounded-lg p-4">
                <h4 className="text-cyber-accent-cyan font-medium mb-2">📐 数学表示</h4>
              ...
              <div className="bg-cyber-bg-secondary rounded-lg p-4">
                <h4 className="text-cyber-accent-purple font-medium mb-2">⚙️ 实现细节</h4>
                <ul className="text-sm text-gray-400 space-y-2">
            ...
            <div className="mt-4 p-4 bg-cyber-bg-secondary rounded-lg">
              <p className="text-gray-400 text-sm">
